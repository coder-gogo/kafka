...
class Broker {
  ...
  static final Map<String, Broker> _instances = Map();
...
class TopicPartition {
  ...
  static final Map<String, TopicPartition> _cache = Map();
  ...
  @override
  bool operator ==(other) {
    return ((other as TopicPartition).topicName == topicName && other.partitionId == partitionId);
  }
